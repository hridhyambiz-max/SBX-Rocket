...
import { collection, query, where, getDocs, doc, writeBatch, serverTimestamp } from "https://www.gstatic.com/firebasejs/12.1.0/firebase-firestore.js";
...
async function hydrate(){
 const [profiles,tasks,attendance,leaves]=await Promise.all([all("users"),all("tasks"),all("attendance"),all("leaveRequests")]);
